...
const float RightOffset = 1.0; // Right motor offset. Less value == less energy given to the motor.

// 9v = 150, 120, 90
// 5v = 255, 210, 180
const float btMaxSp = 255; // Maximum speed, mainly for just forwarding/backwarding.
const float btMedSp = 210; // Medium speed, mainly for 45 degrees turn.
const float btLowSp = 180; // Low speed, mainly for turning L/R.
